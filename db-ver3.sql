...
CREATE TABLE brand_stores (
    ...
    deleted_at TIMESTAMP,
    deleted BOOLEAN DEFAULT false,
    CONSTRAINT fk_brand_stores_brands_id FOREIGN KEY (brand_id) REFERENCES brands(brand_id),
    CONSTRAINT fk_brand_stores_stores_id FOREIGN KEY (store_id) REFERENCES stores(store_id)
);
